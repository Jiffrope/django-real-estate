...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+64271234567')
    about_me = models.TextField(verbose_name=_('About Me'), default='Share somethign about yourself')
    license = models.CharField(verbose_name=_('Real Estate License'), max_length=20, blank=True, null=True)
    profile_photo = models.ImageField(verbose_name=('Profile Photo'), default="/profile_default.png")
    gender = models.CharField(verbose_name=_('Gender'), choices=Gender.choices, max_length=20)
    country = CountryField(verbose_name=_('Country'), default='NZ', blank=False, null=False)
    city = models.CharField(verbose_name=_('City'), max_length=180, default='Tauranga', blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_('Buyer'), default=False, help_text='Are you looking to buy a property?')
    is_seller = models.BooleanField(verbose_name=_('Seller'), default=False, help_text='Are youlooking to sell a property?')
